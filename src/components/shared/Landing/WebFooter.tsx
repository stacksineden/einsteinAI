  ...
  return (
    <div className="bg-zinc-900 text-zinc-100">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-y-10 px-20 md:px-32 py-14">
        <div className="space-y-4 text-xs text-zinc-100 cursor-pointer">
      ...
      <div className="px-10 md:px-32 py-4 grid grid-cols-1 md:grid-cols-2 border-t-[1px] border-zinc-800 space-y-2 md:space-y-1">
