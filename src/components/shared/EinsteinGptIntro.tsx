...
const EinsteinGptIntro = () => {
  ...
  return (
    <div className="text-primary-black overflow-y-auto overflow-hidden scrollbar-hide flex-col items-center justify-center px-2 mt-9 md:mt-20">
      ...
      {/* desktop */}
      <div className="hidden md:grid grid-cols-1 md:grid-cols-4 gap-2 max-w-full md:max-w-[80%] mx-auto">
        <div
